...
public class UserPropertyValidator {
    ...
    public static boolean isPasswordValid(final String password) {
        return password != null && password.length() >= 8 && contains4SequentialCharacters(password) == false;
    }

    private static boolean contains4SequentialCharacters(final String s) {
